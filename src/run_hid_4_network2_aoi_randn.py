...
trials = 10
trial_ev = []
network2_aoi_randn.AOI = 15

for t in xrange(trials):
    net = network2_aoi_randn.Network([784, 50, 50, 50, 50, 10], cost=network2_aoi_randn.CrossEntropyCost)
    net.default_weight_initializer()
    _, ev, _, _ = net.SGD(training_data[:1000], epochs, m_b_s, eta, evaluation_data=test_data[:1000],
